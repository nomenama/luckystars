...
const products = [
    {
        name: "Euromillions",
        description:
            "Out of this world jackpots. The first draw was held on" + " 13 February 2004.",
        href: "/euromillions",
        icon: TicketIcon,
    },
    {
        name: "Lotto",
        description:
            "Lotto by The National Lottery. The first draw was held" +
            " on" +
            " 07 January 1995 in the UK.",
        href: "/lotto",
        icon: CursorArrowRaysIcon,
    },
];
const callsToAction = [
    { name: "Donate", href: "#", icon: CurrencyDollarIcon },
